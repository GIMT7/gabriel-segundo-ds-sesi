programa {
  ...
  funcao inicio() {
    real calctot, calc, c, i, temp, ar, cas, gt, cont, guia, are
      ...
      escreva("\n 1- Juros Compostos,      2- Juros Simples,        3- Guia sobre o que é cada investimento,        4- Sair :    ")
      leia(cas)
      escolha(cas){
    caso 1:                                                                               
      limpa()
     ...
     escreva("O valor simulado do investimento depois do tempo estimado é de: $ ", ar)
     pare
       } 
     senao se(gt==2) {
      escreva("Digite o capital inicial do investimento: ")
     ...
     ar=MAT.arredondar(calc, 2)
     are = c+ar
     escreva("O valor simulado do investimento depois do tempo estimado é de: $ ", are)
     pare
       } 
     senao se(gt==2) {
      escreva("Digite o capital inicial do investimento: ")
