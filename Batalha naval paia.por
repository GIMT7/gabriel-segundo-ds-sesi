programa {
    ...
    inteiro linhan, colun, cont, linhap, colunp, linhas, coluns, linhah, coluh, linhac, coluc
    cadeia emba
  ...
  funcao recebeValor(){
    ...
    para(cont = 0; cont<= 5; cont++){
        escreva("Digite qual embarcação você irá posicionar:")
        escreva("\n------------------------------------------------------------------------------------------------------")
        ...
        se(not == falso){ 
        limpa()
        para(inteiro conta=0; conta<=0; contaa++){
        escreva("Digite a posição horizontal do Navio (eixo x) de 0 a 9: ")
        leia(linhan)
        se(linhan>9 ou linhan<0){
        ...
        escreva("Digite a posição vertical do Navio (eixo y) de 0 a 9: ")
        leia(colun)
      ...
      senao{escreva("<<<Embarcação já posicionada, por favor insira outra embarcação>>>")
            cont-=1
            }
         caso 2:
        se(por == falso){
        ...
        escreva("Digite a posição horizontal do Porta - Aviões (eixo x) de 0 a 9: ")
        leia(linhap)
        ...
        escreva("Digite a posição vertical do Porta - Aviões (eixo y) de 0 a 9: ")
        leia(colunp)
        se(colunp>9 ou colunp<0){
          escreva("<<<<<<<<<<<POSIÇÃO INVÁLIDA>>>>>>>>>>")
          continuar()
          contaaaa=-1
          logico por = verdadeiro
         } 
        }
       }
       senao{escreva("<<<Embarcação já posicionada, por favor insira outra embarcação>>>")
        ...
        escreva("Digite a posição horizontal do Cruzador (eixo x) de 0 a 9: ")
        leia(linhac)
        ...
        escreva("Digite a posição vertical do Cruzador (eixo y) de 0 a 9: ")
        leia(coluc)
        se(coluc>9 ou coluc<0){
          escreva("<<<<<<<<<<<POSIÇÃO INVÁLIDA>>>>>>>>>>")
          continuar()
          contaaaaaa=-1
          logico cru = verdadeiro
         } 
        }
      }senao{escreva("<<<Embarcação já posicionada, por favor insira outra embarcação>>>")
          cont-=1 }
        ...
        escreva("Digite a posição horizontal do Submarino (eixo x) de 0 a 9: ")
        leia(linhas)
        ...
        escreva("Digite a posição vertical do Submarino (eixo y) de 0 a 9: ")
        leia(coluns)
        se(coluns>9 ou coluns<0){
          escreva("<<<<<<<<<<<POSIÇÃO INVÁLIDA>>>>>>>>>>")
          continuar()
          contaaaaaaaa=-1
          logico sub = verdadeiro
         } 
        }
       }senao{escreva("<<<Embarcação já posicionada, por favor insira outra embarcação>>>")
            cont-=1
        ...
        escreva("Digite a posição horizontal do Hidro - Avião (eixo x) de 0 a 9: ")
        leia(linhah)
        ...
        escreva("Digite a posição vertical do Hidro - Avião (eixo y) de 0 a 9: ")
        leia(coluh)
        se(coluh>9 ou coluh<0){
          escreva("<<<<<<<<<<<POSIÇÃO INVÁLIDA>>>>>>>>>>")
          continuar()
          contaaaaaaaaaa=-1
          logico hid = verdadeiro
         } 
        }
        }senao{escreva("<<<Embarcação já posicionada, por favor insira outra embarcação>>>")
            cont-=1
